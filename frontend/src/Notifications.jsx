...
//       console.log("Raw notifications data:", data); // DEBUG - Check the full response
      
//       // Filter out join_request notifications that have a corresponding participant_joined notification
//       const filteredNotifications = (data.notifications || []).filter(notification => {
//         if (notification.type !== 'join_request') return true;
        
//         // Check if there's a participant_joined notification for this ride and requester
//         const hasMatchingJoinNotification = data.notifications.some(n => 
//           n.type === 'participant_joined' && 
//           n.ride_id === notification.ride_id &&
//           n.requester?.id === notification.requester?.id
//         );
        
//         return !hasMatchingJoinNotification;
//       });
...
//       if (response.ok) {
//         // Instead of showing an alert, we'll show the success message in the UI
//         // and refresh the notifications to get the updated list
...
//         fetchNotifications(); // Refresh to show new "declined" notification
//       }
//     } catch (error) {
...
//         },
//       });
//       setNotifications([]); // Clear notifications immediately
//     } catch (error) {
...
//     console.log("Full notification object:", notification); // DEBUG
//     console.log("Notification type:", notification.type); // DEBUG
    
//     // Check for ride_id in different possible field names
//     const rideId = notification.ride_id || notification.rideId || notification.ride?._id;
//     console.log("Ride ID (all possible fields):", {
...
//     const isRequestAccepted = notification.type === 'request_accepted' || notification.type === 'participant_joined';
//     const isRequestDeclined = notification.type === 'request_declined';
    
//     // Skip rendering if this is a join request that's already been handled
//     if (isJoinRequest && notification.status === 'accepted') {
//       return null;
//     }
    
//     // Debug the button conditions
//     console.log("Button conditions:", {
//       isNewRide,
//       hasRideId: !!rideId,
//       showViewRideButton: isNewRide && rideId
//     });
...
//               <span className="notification-emoji">{getNotificationEmoji()} </span>
...
//           {isJoinRequest && !isRequestAccepted && (
//             <div className="notification-buttons">
//               <button 
//                 className="notification-btn notification-btn-accept"
//                 onClick={() => handleAccept(notification.id, notification.ride_id)}
//               >
...
//             </div>
//           )}
//           {isRequestAccepted && notification.type === 'participant_joined' && (
//             <div className="notification-status">
//               <span className="notification-status-text">✓ {notification.message || 'User has successfully joined the ride'}</span>
//             </div>
//           )}

//           {/* Show View Ride button for new_ride, request_accepted, and request_declined notifications */}
//           {(isNewRide || isRequestAccepted || isRequestDeclined) && rideId && (
//             <button 
...
//             <p className="notifications-subtitle">Stay updated on your rides</p>
//           </div>
