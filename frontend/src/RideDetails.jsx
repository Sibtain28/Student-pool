...
//       alert("Successfully joined the ride! The creator will be notified.");
//       navigate("/my-rides");
//     } catch (error) {
...
//   const isCreator = currentUserId && ride && ride.creator.id === currentUserId;
...
//   // Render for NON-CREATOR (other users viewing to join)
//   if (!isCreator) {
//     return (
//       <div className="ride-details-container">
//         <header className="dashboard-header">
...
//               >
//                 {joiningRide ? "Joining..." : ride.seats_available === 0 ? "Ride Full" : "Request to Join"}
//               </button>
            ...
            <div className="ride-joiner-main-card">
              ...
              {joinRequestStatus === 'pending' ? (
                ...
                <div className="request-accepted-banner">
                  ...
                  <span>✅ Request Accepted - You're in!</span>
                </div>
